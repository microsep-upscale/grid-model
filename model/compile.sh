...
# compiler + flags
FC=gfortran
FCFLAGS="-O2 -Wall -Wextra -fbacktrace"
...
$FC $FCFLAGS -c mu_rho_inversion.f90
...
grid.o timestep_control.o run_single_fluid_mod.o mu_rho_inversion.o pressure_integration.o numerical_gradient.o \
